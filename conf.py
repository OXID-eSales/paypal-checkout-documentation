...
html_context = {
    ...
    'versions65': [
         ...
         ('2.3', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/2.3/'),
         ('2.4', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/2.4/'),
         ...
         ('2.7', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/2.7/'),
         ('2.8', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/2.8/'),
         ('2.10', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/2.10/'),
     ],
    'versions70': [
         ...
         ('3.6', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/3.6/'),
         ('3.7', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/3.7/'),
         ('3.9', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/3.9/'),
    ],
    'languages':
       [('DE', 'https://docs.oxid-esales.com/modules/paypal-checkout/de/2.10/'),
        ('EN', 'https://docs.oxid-esales.com/modules/paypal-checkout/en/2.10/')],
...
latex_documents = [
    (master_doc, 'PayPaldoc.tex', 'PayPal Checkout module documentation',
...
man_pages = [
    (master_doc, 'PayPaldoc', 'PayPal Checkout module documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PayPaldoc', 'PayPal Checkout module documentation',
     author, 'PayPaldoc', 'One line description of project.',
     'Miscellaneous'),
]
