...
Um die Funktionen und Korrekturen von :productname:`PayPal Checkout` V. 3.3 zu nutzen, machen Sie ein Update.

Weitere Informationen finden Sie unter ref:`installation:Minor Update installieren`.

.. todo:     * :ref:`installation:Patch-Update installieren`
