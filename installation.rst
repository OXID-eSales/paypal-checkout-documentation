...
* If you have OXID eShop version 6.3.x to 6.5.x, install :productname:`PayPal Checkout` 2.x.x.
  |br|
  For more information, see the corresponding module documentation under `Installing PayPal Checkout 2.5.x <https://docs.oxid-esales.com/modules/paypal-checkout/en/2.5/installation.html>`_.
...
For OXID eShop version 7.x, install the payment module :productname:`PayPal Checkout` version 3.5.x.
...
If you use a deprecated version, perform a minor update, for example from :productname:`PayPal Checkout` version 3.4.0 to version 3.5.0.
...
1. Execute the following console commands:
   ...
   .. code:: bash
      ...
      composer require --with-all-dependencies oxid-solution-catalysts/paypal-module ^3.5.0
