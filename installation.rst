...
* If you have OXID eShop version 6.3.x to 6.5.x, install :productname:`PayPal Checkout` 2.6.x (see :ref:`installation:Installing PayPal Checkout`).
...
For OXID eShop version 6.3.x to 6.5.x, install the payment module :productname:`PayPal Checkout` version 2.6.x.
...
1. Execute the following console command:
   ...
   .. code:: bash
      ...
      composer require composer require --update-with-all-dependencies oxid-solution-catalysts/paypal-module ^2.6.0
