...
* Wenn Sie OXID eShop Version 6.3.x bis 6.5.x haben, installieren Sie :productname:`PayPal Checkout` 2.2.0 wie im Folgenden beschrieben.
* Wenn Sie OXID eShop Version 7.x haben, installieren Sie `PayPal Checkout 3.x <https://docs.oxid-esales.com/modules/paypal-checkout/de/3.3/>`_.
* Wenn Sie OXID eShop Version 6.1.x oder 6.2.x haben, installieren Sie `PayPal Checkout 1.x <https://docs.oxid-esales.com/modules/paypal-checkout/de/1.2/>`_.
...
Installieren Sie bei Bedarf ein Patch-Update, beispielsweise von :productname:`PayPal Checkout` Version 2.2.0 auf Version 2.2.2.
